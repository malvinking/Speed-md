let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `ꜱᴩᴇᴇᴅ ᴛᴇᴄʜ 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍E𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊:* https://whatsapp.com/channel/0029Vac8SosLY6d7CAFndv3Z\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = 'ꜱᴩᴇᴇᴅ-ᴍᴅ 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/CibIQyQI3Em1HbUD0aVXez \n\n ${Config.botname} *WORKS*`;
